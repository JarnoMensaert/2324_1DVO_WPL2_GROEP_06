...
<template>
  ...
  <p class="voorwaardenTekst">Ondanks het feit dat de online catalogus en de e-commerce website met de grootst mogelijke
    ...
    fouten bevat, of niet up-to-date is. Kennelijke vergissingen of fouten in het aanbod binden Comfortmeubel niet. De
    foto’s, teksten, afmetingen en details die het product beschrijven zijn in geen enkele omstandigheden bindend
    opzichtens Comfortmeubel. Comfortmeubel is in geen geval Aansprakelijk ingeval van materiële fouten, zet- of
    drukfouten. 
    Wanneer de Klant specifieke vragen heeft over bv. maten, kleur, beschikbaarheid, leveringstermijn of leveringswijze,
    verzoeken wij de Klant om vooraf contact op te nemen met onze Klantendienst.
    Het aanbod geldt steeds zolang de voorraad strekt en kan te allen tijde worden aangepast of ingetrokken door
    Comfortmeubel. Comfortmeubel kan niet aansprakelijk gesteld worden voor het niet beschikbaar zijn van een product.
    Indien een aanbod een beperkte geldigheidsduur heeft of onder voorwaarden geschiedt, wordt dit nadrukkelijk in het
    aanbod vermeld.
    Comfortmeubel is gerechtigd om – zonder opgave van redenen – bestellingen te weigeren, de leveringstermijnen aan te
    passen, de leveringen te splitsen, dan wel andere voorwaarden te verbinden aan de levering. </p>
  <p class="voorwaardenTitel">Artikel 4 – BESTELLEN  </p>
  <p class="voorwaardenTekst">De producten en diensten worden te koop aangeboden via de website www.comfortmeubel.be. De
    Klant ontvangt via email na de aankoop met een bevestiging van zijn bestelling waarin alle contractuele informatie
    met betrekking tot de bestelling wordt meegedeeld aan de Klant. Zoals bovenaan deze pagina aangehaald zijn al deze
    voorwaarden geldig voor aankopen op de website www.comfortmeubel.be. De voorwaarden bij bestellingen in de winkel
    vind de Klant hier.
    Comfortmeubel kan niet verantwoordelijk gesteld worden voor het niet beschikbaar zijn van een product of dienst bij
    de Leverancier, noch voor de schade die daar zou uit kunnen voortvloeien. In het geval één of meerdere producten of
    diensten van een bestelling niet beschikbaar zouden zijn, zal de Klant via e-mail of telefonisch op de hoogte
  ...
  <p class="voorwaardenTitel">Artikel 6 – LEVERING</p>
  <p class="voorwaardenTekst">Tenzij uitdrukkelijk overeengekomen zijn leveringstermijnen informatief en vormen geen
    ...
    verrichten binnen een aanvullende termijn die gezien de omstandigheden passend is. Contact opnemen moet gebeuren via
    de telefoon of per mail naar info@comfortmeubel.be.
    Indien Comfortmeubel de levering niet binnen voormelde aanvullende termijn levert, heeft de Klant het recht om de
    overeenkomst te beëindigen. De terugbetaling zal gebeuren binnen de 14 dagen, op voorwaarde dat alle voorwaarden
    zoals beschreven in deze algemene voorwaarden strikt voldaan zijn. Het bedrag dat terugbetaald wordt zal in elk
    geval nooit groter zijn dan het door de Klant effectief betaalde bedrag. 
    ...
    moeten door de Klant onverwijld en onmiddellijk worden gemeld aan Comfortmeubel.
    De bestellingen worden geleverd op het leveradres zoals het door de Klant opgegeven wordt tijdens het bestelproces
    en volgens de voorwaarden die aldaar beschreven worden. De artikelen worden standaard niet gemonteerd bij de
    levering tenzij hiervoor, na overleg met de Klantendienst, een afspraak werd gemaakt tegen een afgesproken
    meerprijs. Ook een ladderlift dient apart aangevraagd te worden en kost € 75,00 per uur tot de vijfde verdieping in
    Antwerpen. Wanneer de Klant hiervoor kiest en dit dus aanvinkt, organiseert Comfortmeubel de ladderliftdienst. Heel
    belangrijk is dat er zeker 10 meter opening beschikbaar is voor de deur. Hiervoor moet de Klant bij zijn gemeente of
    stad op tijd parkeerborden aanvragen. Indien er onvoldoende plaats beschikbaar is en de levering niet kan worden
    uitgevoerd, gaat de leverdienst verder. Een tweede ladderlift komt dan op € 150,00. De ladderliftdiensten buiten
    Antwerpen en/of hoger dan 5 verdiepingen moeten specifiek aangevraagd worden. Wanneer de klant de dienst aanvinkt,
    neem de Klantendienst contact op met de Klant.
    Het karton of verpakkingsmateriaal wordt nooit meegenomen tenzij Comfortmeubel ook de montage doen. In alle andere
    gevallen blijven de producten ingepakt. Indien de producten worden gemonteerd, kan Comfortmeubel geen enkel product
    meer terug aannemen. De montagekost is afhankelijk van het te monteren product en wordt duidelijk en ondubbelzinnig
    meegedeeld bij het aanvragen van deze extra service.
    De bestellingen kunnen alleen geleverd worden op adressen die gelegen zijn in België. Comfortmeubel kan de
    bestelling op splitsen in één of meerdere leveringen in functie van de beschikbaarheid van de producten. Elke
    levering wordt aangekondigd via e-mail of per telefoon. Op de factuur worden ook de transportkosten en de BTW
    vermeld. De levering is vergezeld van een leverbon, waarop ook de details van de geleverde goederen zijn vermeld. De
    levering wordt aangeboden aan de Klant of aan elke andere persoon die aanwezig is op het leveradres. Als niemand het
    pakket in ontvangst kan nemen op het moment dat het aangeboden wordt, zal de transporteur terug vertrekken. De Klant
    moet dan zelf contact opnemen met Comfortmeubel om te zien waar en wanneer het pakket opgehaald kan worden door de
    Klant of opnieuw worden geleverd tegen extra leverkosten. Deze bedraagt de oorspronkelijke leverkost plus een extra
    van 50 euro.
    Afhankelijk van de grootte van uw aankoop worden aankopen opgesplitst in pakjesdienst en meubeltransport. Kleine
    pakketten worden opgestuurd via de pakjesdienst en het kost € 9,95 per pakket. Grote pakketten worden geleverd door
    onze meubeltransportdienst. Hierbij geldt dat wanneer de totale aankoopsom boven € 1.000,00 is, het gratis
    gelijkvloers wordt geleverd in Arrondissement Antwerpen. Wanneer de totale aankoopsom onder de € 1.000,00 is, worden
    de aankopen in Arrondissement Antwerpen gelijkvloers geleverd voor € 45,00. Wanneer de totale aankoopsom boven €
    1.500,00 is, wordt de aankoop gratis gelijkvloers geleverd in Brussel hoofdstedelijk gewest. Wanneer de totale
    aankoopsom onder de € 1.500,00 is, worden de aankopen in Brussel hoofdstedelijk gewest gelijkvloers geleverd voor €
    75,00. 
    In resterende plaatsen te provincie Antwerpen, Oost-Vlaanderen, Vlaams-Brabant en Limburg wordt er geleverd voor €
    75,00, in West-Vlaanderen, Henegouwen, Waals-Brabant en Luik komt dit op € 125,00 en in Luxemburg komt dit op €
    175,00. Alle prijzen gelden hier voor levering gelijkvloers en houden geen rekening met het aankoopbedrag.
    Het is de verantwoordelijkheid van de Klant om de levering op de afgesproken plaats mogelijk te maken in
    aanwezigheid van de Klant of een door de Klant aangewezen derde partij. Er is sprake van een levering zodra de
    bestelde Producten één keer aan de Klant zijn aangeboden. Indien een aangeboden levering onsuccesvol is ten gevolge
    van een tekortkoming door de Klant of de door Klant aangewezen derde partij, dan zijn de kosten van nieuwe
  ...
  <p class="voorwaardenTitel">Artikel 7 – VERZAKINGSRECHT/RETOURS</p>
  <p class="voorwaardenTekst">De bepalingen van dit artikel gelden enkel voor Klanten die in hun hoedanigheid van
    consument artikelen online aankopen bij Comfortmeubel.
    De Klant heeft het recht om binnen een termijn van 14 kalenderdagen zonder opgave van redenen de overeenkomst te
    herroepen. De herroepingstermijn verstrijkt 14 kalenderdagen na de dag waarop de Klant of een door de Klant
    aangewezen derde, die niet de vervoerder is, het goed fysiek in bezit krijgt.
    Om het herroepingsrecht uit te oefenen, moet de Klant Comfortmeubel zijn/haar beslissing de overeenkomst te
    herroepen meedelen. De Klant dient hiervoor gebruik te maken van het modelformulier voor herroeping. Dit formulier
    kan de Klant helemaal onderaan de algemene voorwaarden terugvinden. 
    De Klant kan het modelformulier voor herroeping ook elektronisch invullen en opsturen via onze website. Als de Klant
    van deze mogelijkheid gebruik maakt zullen wij de Klant onverwijld op een duurzame gegevensdrager (bv. per e-mail)
    een ontvangstbevestiging van zijn herroeping sturen”.
    ...
    De Klant moet de goederen onverwijld, doch in ieder geval niet later dan 14 kalenderdagen na de dag waarop hij zijn
    beslissing om de overeenkomst te herroepen aan Comfortmeubel heeft meegedeeld, terugzenden of overhandigen aan
    Comfortmeubel of een gemachtigd transporteur. De Klant is op tijd als hij de goederen terugstuurt voordat de termijn
    van 14 kalenderdagen is verstreken.
    Enkel artikelen die zich in de originele verpakking bevinden, in zijn nieuwe oorspronkelijke staat samen met alle
    ...
    kan geïdentificeerd worden zal geweigerd worden. Indien op dag 15 het product nog steeds niet is aangekomen, vervalt
    het herroepingrecht onmiddellijk. De retour moet verstuurd worden naar het adres van het magazijn dat vermeld staat
    in huidige voorwaarden. De directe kosten van het terugzenden van de goederen en/of de ophaalkosten komen voor
    rekening van de Klant.
    De terugbetaling zal gebeuren binnen de 14 dagen na ontvangst van de retour door Comfortmeubel, op voorwaarde dat
    alle voorwaarden zoals hierboven beschreven strikt voldaan zijn. Het bedrag dat terugbetaald wordt zal in elk geval
    nooit groter zijn dan het door de Klant effectief betaalde bedrag. 
    Het verzakingsrecht kan ook uitgeoefend worden nadat de aankoop gedaan is, maar vóór dat de bestelling verzonden is.
    Hiervoor dient de Klant een aangetekend schrijven te verzenden naar Comfortmeubel, waarin zij vermelden dat zij
    willen afzien van de aankoop. In dat geval zal de terugbetaling gebeuren binnen de 14 dagen na ontvangst van de
    annulering van de bestelling. Comfortmeubel zal een email versturen op het ogenblik dat zij de retour ontvangen
    heeft.
    De Klant kan het herroepingsrecht niet uitoefenen voor:
    producten die op maat gemaakt zijn of aangepast zijn aan de wensen van de Klant, onder persoonlijk karakter vallen
    bijvoorbeeld zetels en stoelen die een andere kleur en opstelling hebben dan de beschikbare foto’s op de site. In de
    hierboven vermelde gevallen kan de Klant noch het product terugsturen, noch een terugbetaling eisen. 
    de levering of verstrekking van goederen of diensten waarvan de prijs gebonden is aan schommelingen op de financiële
    markt waarop Comfortmeubel geen invloed heeft en die zich binnen de herroepingstermijn kunnen voordoen;
    de levering van volgens specificaties van de Klant vervaardigde goederen, of die duidelijk voor een specifieke
    persoon bestemd zijn;(bijvoorbeeld maatwerk)
    ...
    de levering van verzegelde audio- en verzegelde video-opnamen en verzegelde computerprogrammatuur waarvan de
    verzegeling na levering is verbroken;
    overeenkomsten die zijn gesloten tijdens een openbare veiling;
    de terbeschikkingstelling van accommodatie anders dan voor woondoeleinden, goederenvervoer, autoverhuurdiensten,
    catering en diensten met betrekking tot vrijetijdsbesteding, indien in de overeenkomsten een bepaalde datum of
    periode van uitvoering is voorzien.
    Indien het teruggestuurde product op een of andere manier in waarde verminderd is, behoudt Comfortmeubel zich het
    recht voor om de Klant aansprakelijk te stellen en schadevergoeding te eisen voor elke waardevermindering van de
    goederen die het gevolg is van het gebruik van de goederen door de Klant dat verder gaat dan nodig is om de aard, de
    kenmerken en de werking van de goederen vast te stellen.</p>
  <p class="voorwaardenTitel">Artikel 8 – GARANTIE</p>
  ...
  <p class="voorwaardenTekst">Comfortmeubel kan in geen geval verantwoordelijk gehouden worden voor directe of indirecte
    schade van welke aard dan ook. Comfortmeubel treft verder geen enkele verantwoordelijkheid voor de inhoud van de
    websites van derden waarnaar een link is opgenomen in de website.
    Comfortmeubel kan niet verantwoordelijk gehouden worden voor gebeurlijke fouten in de foto´s of de teksten die
    gebruikt worden voor de product omschrijvingen op de website  www.comfortmeubel.be, op alle sociale media of in onze
    folder.
    Comfortmeubel wijst elke verantwoordelijkheid af voor de schade die veroorzaakt wordt door een gebrek, het slecht
    functioneren of het verkeerd gebruik van een product dat verkocht werd op de website van www.comfortmeubel.be.
    Comfortmeubel kan niet verantwoordelijk gehouden worden voor het niet kunnen leveren van de bestellingen, hieronder
    begrepen de gevallen van overmacht, verstoring of staking van transport -, post -, of communicatie diensten, in
    geval van overstroming of brand. In alle gevallen waar de verantwoordelijkheid van Comfortmeubel aangesproken wordt,
    is de verantwoordelijkheid van Comfortmeubel beperkt tot het bedrag dat door de Klant effectief betaald werd voor
    een bestelling.</p>
  <p class="voorwaardenTitel">Artikel 13 – WIJZIGINGEN VAN DE ALGEMENE VOORWAARDEN</p>
  <p class="voorwaardenTekst">Comfortmeubel kan op elk moment de onderliggende Algemene Voorwaarden wijzigen, onder
    andere om zich te schikken naar wettelijke verplichtingen. De Klanten zullen op adequate manier verwittigd worden
    van eventuele wijzigingen in de Algemene Voorwaarden, via de rubriek “Help & Contact” op de website van
    www.comfortmeubel.be, of op een andere manier. De Klanten engageren zich om kennis te nemen van de wijzigingen, van
    zodra ze hiervan op de hoogte gebracht zijn. Elk gebruik van de Diensten, zoals beschreven in Artikel 2, nadat door
    Comfortmeubel gecommuniceerd is over de gewijzigde Algemene Voorwaarden, veronderstelt de kennisname en
    onderschrijving van de gewijzigde Algemene Voorwaarden. 
    Comfortmeubel behoudt zich het recht voor om op elk moment het ontwerp en de inhoud van haar website te wijzigen. In
    de mate van het mogelijke, zal Comfortmeubel elke belangrijke wijziging meedelen aan haar Klanten. De Klanten hebben
    de volledige vrijheid om bij een wijziging aan de Algemene Voorwaarden, of aan de lay-out of inhoud van de website
    van www.comfortmeubel.be hun account te deactiveren. </p>
  <p class="voorwaardenTitel">Artikel 14 – NIETIGHEID</p>
  ...
  <p class="voorwaardenTitel">Artikel 15 – KLACHTEN</p>
  <p class="voorwaardenTekst">Klantentevredenheid is een topprioriteit voor Comfortmeubel en wij streven er elke dag
    naar om dit te verbeteren. Elke Klant van Comfortmeubel met een vraag of klacht, vragen we daarom om altijd contact
    op te nemen met de winkel via de contactenformulier op onze website. Wij beantwoorden geen klachten via de telefoon
    of per e-mail.</p>
  ...
  <p class="voorwaardenTekst">De verantwoordelijke voor de verwerking respecteert de Belgische wet van 8 december 1992
    ...
    Uw informatie wordt zeker en vast nooit verkocht of meegedeeld met derden. Enkel wanneer wij wettelijk hiertoe
    verplicht worden kan dit gebeuren.
    Reviews achtergelaten door U kunnen verder gebruikt worden zonder vermelding van U naam of e-mailadressen voor
    commerciële doeleinden zoals gebruik van de reviews bij printadvertenties en ander sociale media.</p>
  <p class="voorwaardenTitel">Artikel 15 – BEWIJS</p>
  <p class="voorwaardenTekst">De Klant aanvaardt dat elektronische communicaties en back-ups als bewijsvoering kunnen
    dienen.</p>
  <p class="voorwaardenHoofdtitel">ALGEMENE VOORWAARDEN BIJ AANKOPEN IN DE WINKEL</p>
  <p class="voorwaardenTekst">Modelformulier voor herroeping = dit formulier alleen invullen en aangetekend terugzenden
    als u de overeenkomst wilt herroepen
